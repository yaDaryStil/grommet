...
var Anchor = function (_Component) {
  ...
  (0, _createClass3.default)(Anchor, [{
    ...
    value: function render() {
      ...
      var styles = (0, _anchor2.default)(this.context.theme);
      ...
      var iconClasses = (0, _classnames4.default)(styles.icon.className, (_classnames = {}, (0, _defineProperty3.default)(_classnames, styles.iconReverse, reverse), (0, _defineProperty3.default)(_classnames, styles.iconAnimate, defaultIcon && !disabled), (0, _defineProperty3.default)(_classnames, styles.iconPrimary, primary), _classnames));
      ...
      var classes = (0, _classnames4.default)(className, styles.common.className, colors.invertWhenDark.className, (_classnames2 = {}, (0, _defineProperty3.default)(_classnames2, styles.disabled, disabled), (0, _defineProperty3.default)(_classnames2, styles.hasIcon, hasIcon), (0, _defineProperty3.default)(_classnames2, styles.iconLabel, hasIcon && label), (0, _defineProperty3.default)(_classnames2, styles.primary, primary), _classnames2));
